  ...
  const initMerchants = () => {
    merchants.value = [
      // 汽车经销商 (5个)
      {
        ...
        name: '江苏汽车城',
        category: 'car_dealer',
        logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><rect fill="%23FF6B35" width="100" height="100"/><text x="50" y="50" font-size="40" text-anchor="middle" dy=".3em" fill="white">🚗</text></svg>',
        images: ['data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="300"><rect fill="%23f0f0f0" width="400" height="300"/><text x="200" y="150" font-size="60" text-anchor="middle" dy=".3em" fill="%23999">🏪</text></svg>'],
        rating: 4.8,
        reviewCount: 2580,
      ...
      // 家电商店 (5个)
      {
        ...
        logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><rect fill="%23F7931E" width="100" height="100"/><text x="50" y="50" font-size="40" text-anchor="middle" dy=".3em" fill="white">🔌</text></svg>',
        images: ['data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="300"><rect fill="%23f0f0f0" width="400" height="300"/><text x="200" y="150" font-size="60" text-anchor="middle" dy=".3em" fill="%23999">🏪</text></svg>'],
        rating: 4.7,
        reviewCount: 5600,
      ...
      // 家具商店 (5个)
      {
        ...
        logo: 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100"><rect fill="%2367 eea" width="100" height="100"/><text x="50" y="50" font-size="40" text-anchor="middle" dy=".3em" fill="white">🏪</text></svg>',
        images: ['data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="400" height="300"><rect fill="%23f0f0f0" width="400" height="300"/><text x="200" y="150" font-size="60" text-anchor="middle" dy=".3em" fill="%23999">🏪</text></svg>'],
        rating: 4.7,
        reviewCount: 4500,
